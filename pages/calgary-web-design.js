  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Bernum: Your Calgary Web Design Experts in Canada. Crafting Stunning Websites with Precision. To Know More Connect with Us Today!" />
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              <b>Calgary <a className="seo-link" href="https://bernum.ca/web-design/"> web design </a> </b>stands as an essential cog in Alberta's
              bustling urban scene, creating unforgettable digital experiences
              through web designs that provide access to cutting-edge
              technology, style, and knowledge that redefine business branding
              in digital markets. We design tailored websites specifically
              tailored for you that foster online growth while leaving an
              irresistibly good first impression with customers.
            </p>
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              ...
              loyal customers as well. Our approach integrates aesthetics and
              function seamlessly. We recognise the significance of web designs
              as storefronts for customers to initially interact with a
              company's brand and products; their initial impression can make or
              break an acquisition decision. At Bernum, we take great pleasure
              in crafting beautiful websites that reflect everything unique
              about you—your values, mission statements, or even
              product-specific features and benefits. These sites are also
              specifically created to increase visitor engagement while
              increasing conversions. Bernum stands out by staying ahead of the
              latest trends in web technology. In order to stay relevant in an
              ever-evolving digital environment, websites must remain agile in
              response to change. Our team researches new techniques and best
              practices so your site not only looks attractive but is
              responsive, safe, and fast as well.
            </p>
            <p>
              ...
              your website to fruition. Bernum can create for your company not
              just an impressive online profile but one that engages its target
              market as well. Come learn how web design transforms viewers, and
              let us join in unlocking all the potential in your online
              identity! Establish your brand in the digital sphere with Bernum's
              help in designing an eye-catching website that showcases it
              effectively.
            </p>
          </div>
        </div>
            ...
            <div className="h-full pt-6">
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  ...
                  <p className="mt-2 text-base leading-snug text-gray-500 md:mt-4 md:leading-relaxed">
                    <b>Calgary  web design
                     </b>Services specializes in responsive
            ...
            <div className="h-full pt-6">
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  ...
                  <p className="mt-2 text-base leading-snug text-gray-500 md:mt-4 md:leading-relaxed">
                    Bernum  web designof Calgary provides user-friendly website
          ...
          <div className="row justify-center mt-12 mx-6">
            <div className="col-md-12 col-sm-12 col-xs-12">
              <p>
                ...
                enhance website appearance with style and the latest tech. Let
                us help your business establish itself online!
              </p>
              <p>
                Bernum's team of web professionals specializes in crafting
                websites that not only look stunning but function seamlessly,
                guaranteeing that your company stands out online and thrives!
                When selecting Bernum for <b>Calgary  web design </b>, you are
                selecting an organization dedicated to both its own success and
                your success!
              </p>
              <p>
                Bernum provides comprehensive web solutions, from site creation
                and redesign through maintenance contracts and support, that
                help companies make an impressive online impression. With years
                of expertise in <b>Calgary  web design</b> solutions and Alberta
                SEO support services at hand, Bernum can serve as your go-to
                company when building strong digital foundations for any Calgary
                or Alberta-based business.{" "}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-12 col-sm-12 col-xs-12">
            ...
            <p>
              Bernum  web design
               ...
               in Calgary goes far beyond just providing
