  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Boost Your Brand with Bernum, Your Trusted Digital Marketing Agency in Kitchener. Connect with Us Today for More Information!" />
        <meta name="keywords" content="Digital Marketing Agency Kitchener" />
      </Head>
      <NavbarStyleTwo />

      <LandingPageBanner pageTitle="Digital Marketing Agency Kitchener" />
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              ...
              increasingly competitive arena of <a className="seo-link" href="https://bernum.ca/digital-marketing/"> digital marketing </a>  successfully.
            </p>
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
            ...
            <div className="h-full pt-6">
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  ...
                  <p className="mt-2 text-base leading-snug text-gray-500 md:mt-4 md:leading-relaxed">
                    Local Focus As our agency is located in Kitchener, it allows
                    us to fully grasp its specific market nuances and craft
              ...
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  ...
                  <p className="mt-2 text-base leading-snug text-gray-500 md:mt-4 md:leading-relaxed">
                    ...
                    through successful digital marketing strategies. 0
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className=" container tabs-three mt-20 ">
        ...
        <div className="row justify-center mt-12 mx-6">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <p>
              At <b>Kitchener digital marketing Agency </b>, our specialty lies
              in crafting an original brand voice that engages and connects with
