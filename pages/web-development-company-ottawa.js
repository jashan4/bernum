  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Transforming Ottawa's Digital Landscape – Bernum, Your Premier Web Development Company Ottawa. To Know More Connect with Us Today!" />
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              Bernum prides itself on being more than just a <a className="seo-link" href="https://bernum.ca/web-development/"> web development </a>
      ...
      <div className=" container contact-des ">
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            ...
            <p>Bernum offers more than just websites; we act as strategic partners
            dedicated to your online success. With experience working with
            start-ups and Fortune 500 companies, Bernum possesses the necessary
            expertise to tailor its services specifically to you and meet all of
