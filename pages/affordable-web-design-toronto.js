...
function Toronto() {
  ...
  return (
    <>
      <Head>
        <title>Get The Most Affordable Web Design Toronto Canada | Bernum</title>
        <meta name="description" content="Bernum Is Providing Best Affordable Web Design Toronto - Crafting Stunning Websites in Canada for Your Business Success." />
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              Bernum offers reliable <a className="seo-link" href="https://bernum.ca/web-design/"> web design </a> in Toronto at competitive
              pricing—affordable  web design Toronto—to give businesses of any
              kind the edge needed to succeed online. Using creative expertise
              and cutting-edge technologies, our expert designers help
              businesses rediscover their online identity so they can thrive
              within this increasingly competitive Internet marketplace. 
            </p>
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              <b>Affordable  web design Toronto</b> is more than a service; it is
              an investment in your company's future. In a city as diverse as
